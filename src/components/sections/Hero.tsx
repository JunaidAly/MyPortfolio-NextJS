            ...
            <motion.div className="space-y-8" variants={slideInLeft}>
              <motion.div className="space-y-6" variants={staggerContainer}>
                ...
                >
                  ...
                  WordPress, Laravel, Node.js, and cloud platforms (AWS, Azure,
                  GCP). Experienced in building SaaS platforms, booking systems,
                  AR-based admin applications, e-commerce solutions, CMS
                  websites, and scalable UI/UX-driven web apps.
                </motion.p>
              </motion.div>
              ...
              {/* Social Links */}
              <motion.div variants={staggerItem} className="flex space-x-6">
                <motion.a
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        ...
        >
          <div className="text-center mb-12">
            ...
            >
              Explore my technical skills and personal interests with my 3D
              animated avatar. Drag to rotate, zoom to get closer, and discover
